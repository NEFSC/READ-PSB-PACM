targets_towed_tracks <- list(
  tar_target(towed_tracks_cruise_dates, {
    read_xlsx(
  ...
  tar_target(towed_tracks_gu1303_file, "data/internal/towed/tracks/GU1303_gpsData.xlsx", format = "file"),
  ...
  tar_target(towed_tracks_gu1402_file, "data/internal/towed/tracks/GU1402_GPS_data.xlsx", format = "file"),
  ...
  tar_target(towed_tracks_gu1605_file, "data/internal/towed/tracks/GU1605_allGPS_Corrected.xlsx", format = "file"),
  ...
  tar_target(towed_tracks_gu1803_files, list.files("data/internal/towed/tracks/GU1803_ShipGPS_EffortAppended_FIXED", full.names = TRUE), format = "file"),
  ...
  tar_target(towed_tracks_hb1103a_file, "data/internal/towed/tracks/HB1103_gpsData.xlsx", format = "file"),
  ...
  tar_target(towed_tracks_hb1103b_file, "data/internal/towed/tracks/HB1103_GPS_data_0729-0730.xlsx", format = "file"),
  ...
  tar_target(towed_tracks_hb1303_file, "data/internal/towed/tracks/HB1303_PG_GPS_ALL_AIedits.xlsx", format = "file"),
  ...
  tar_target(towed_tracks_hb1403_file, "data/internal/towed/tracks/HB1403_Completed_GpsData_AIedits.xlsx", format = "file"),
  ...
  tar_target(towed_tracks_hb1503_1_file, "data/internal/towed/tracks/HB1503_20150615_gpsData.xlsx", format = "file"),
  ...
  tar_target(towed_tracks_hb1503_2_file, "data/internal/towed/tracks/HB1503_Copy of Leg1_gps_June16-18.xlsx", format = "file"),
  ...
  tar_target(towed_tracks_hb1503_3_file, "data/internal/towed/tracks/HB1503_Leg2_ShipGPS.xlsx", format = "file"),
  ...
  tar_target(towed_tracks_hb1603_file, "data/internal/towed/tracks/HB1603_ship_GPS_EchoAdd_All_legs_combined.xlsx", format = "file"),
  ...
  tar_target(towed_tracks_hrs1701_file, "data/internal/towed/tracks/HRS1701_Skala_gpsData.csv", format = "file"),
  ...
  tar_target(towed_tracks_hrs1910_file, "data/internal/towed/tracks/HRS1910_ship_GPS.csv", format = "file"),
  ...
  tar_target(towed_tracks, {
    ...
    df_legs <- df_hr %>% 
      mutate(date = as_date(datetime)) %>% 
      left_join(towed_tracks_cruise_dates, by = c("id", "date"))
    ...
    list(
      cruise_dates = towed_tracks_cruise_dates,
      legs = df_legs,
      raw = towed_tracks_raw,
      data = df_hr,
      sf = sf_tracks
    )
  })
